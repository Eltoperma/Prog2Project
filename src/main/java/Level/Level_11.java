...
public class Level_11 extends Level {
    ...
    private void configureTiles() {
        ...
        drawLineOfWalls(new Position(5, 2), new Position(7, 2));
    ...
    private void configureUpgrades() {
        ...
        upgrades.put(new Position(2, 3), Upgrades.NONE);
        upgrades.put(new Position(3, 3), Upgrades.NONE);
